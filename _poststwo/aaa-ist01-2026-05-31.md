---
title: 01 How to Approach Any System Design Interview
level: interview
layout: post
categories:
- aaa-ist Interview Strategy & Thinking
feature_text: |
  ## System Design Deep Dive - 01 How to Approach Any System Design Interview
...
2. define users and core use cases
3. identify scale and constraints
4. propose a simple baseline architecture
5. deep dive into bottlenecks
6. discuss trade-offs explicitly
7. cover reliability and observability
8. summarize decisions clearly
...
> I would approach **How to Approach Any System Design Interview** with a clear interview structure: clarify, scope, estimate, design, deep dive, trade off, and summarize.
