...
Hello everyone.
Today I’d like to walk through **How Slack Handles Real-time Messaging**.
...
**(PPT 1: Title Slide — How Slack Handles Real-time Messaging)**
...
For **How Slack Handles Real-time Messaging**, I usually begin by asking three questions.
...
1. Core Messaging Framework (Staff-Level)
2. Core Problem
3. High-Level Architecture
4. Message Write Path
5. Fan-out Strategy
...
For **How Slack Handles Real-time Messaging**, the important trade-offs are usually:
...
For **How Slack Handles Real-time Messaging**, remember three things.
...
大家好。
今天我们来讲 **How Slack Handles Real-time Messaging**。
...
第一，Core Messaging Framework (Staff-Level)。
第二，Core Problem。
第三，High-Level Architecture。
第四，Message Write Path。
第五，Fan-out Strategy。
...
讲 **How Slack Handles Real-time Messaging** 时，记住三个点。
