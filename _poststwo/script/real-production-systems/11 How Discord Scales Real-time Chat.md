...
Hello everyone.
Today I’d like to walk through **How Discord Scales Real-time Chat**.
...
**(PPT 1: Title Slide — How Discord Scales Real-time Chat)**
...
For **How Discord Scales Real-time Chat**, I usually begin by asking three questions.
...
1. Core Realtime Chat Framework (Staff-Level)
2. Core Problem
3. High-Level Architecture
4. Gateway Sharding
5. Guild and Channel Partitioning
...
For **How Discord Scales Real-time Chat**, the important trade-offs are usually:
...
For **How Discord Scales Real-time Chat**, remember three things.
...
大家好。
今天我们来讲 **How Discord Scales Real-time Chat**。
...
第一，Core Realtime Chat Framework (Staff-Level)。
第二，Core Problem。
第三，High-Level Architecture。
第四，Gateway Sharding。
第五，Guild and Channel Partitioning。
...
讲 **How Discord Scales Real-time Chat** 时，记住三个点。
