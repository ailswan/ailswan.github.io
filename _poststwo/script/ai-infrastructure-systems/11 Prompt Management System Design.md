...
Hello everyone.
Today I’d like to walk through **Prompt Management System Design**.
...
**(PPT 1: Title Slide — Prompt Management System Design)**
...
For **Prompt Management System Design**, I usually begin by asking three questions.
...
For **Prompt Management System Design**, the important trade-offs are usually:
...
For **Prompt Management System Design**, remember three things.
...
大家好。
今天我们来讲 **Prompt Management System Design**。

这个 topic 的重点不是背一个固定答案，而是学会用 Staff 级思维解释一个系统设计问题。

一句话总结：

> Prompt management 要把 prompt 当 production artifact 管理。Staff 级要说 versioning、template variables、schema validation、eval gates、approval、environment promotion、A/B、observability 和 rollback。
...
讲 **Prompt Management System Design** 时，记住三个点。
