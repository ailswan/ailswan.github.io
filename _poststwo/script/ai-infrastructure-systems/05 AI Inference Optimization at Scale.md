...
## AI Inference Optimization at Scale
...
Hello everyone.
Today I’d like to walk through **AI Inference Optimization at Scale**.
...
**(PPT 1: Title Slide — AI Inference Optimization at Scale)**
...
For **AI Inference Optimization at Scale**, I usually begin by asking three questions.
...
For **AI Inference Optimization at Scale**, the important trade-offs are usually:
...
For **AI Inference Optimization at Scale**, remember three things.
...
大家好。
今天我们来讲 **AI Inference Optimization at Scale**。

这个 topic 的重点不是背一个固定答案，而是学会用 Staff 级思维解释一个系统设计问题。

一句话总结：

> LLM inference optimization 要区分 prefill 和 decode。Staff 级要讲 continuous batching、KV cache、quantization、speculative decoding、parallelism、GPU scheduling、prompt caching，以及 latency/throughput/cost 的 trade-off。
...
讲 **AI Inference Optimization at Scale** 时，记住三个点。
