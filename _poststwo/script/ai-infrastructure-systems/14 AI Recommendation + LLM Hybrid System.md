...
## AI Recommendation + LLM Hybrid System
...
Hello everyone.
Today I’d like to walk through **AI Recommendation + LLM Hybrid System**.
...
**(PPT 1: Title Slide — AI Recommendation + LLM Hybrid System)**
...
For **AI Recommendation + LLM Hybrid System**, I usually begin by asking three questions.
...
For **AI Recommendation + LLM Hybrid System**, the important trade-offs are usually:
...
For **AI Recommendation + LLM Hybrid System**, remember three things.
...
大家好。
今天我们来讲 **AI Recommendation + LLM Hybrid System**。

这个 topic 的重点不是背一个固定答案，而是学会用 Staff 级思维解释一个系统设计问题。

一句话总结：

> AI recommendation + LLM hybrid 不是用 LLM 替代所有推荐系统，而是用传统召回/排序保证规模和成本，再用 LLM 做意图理解、rerank、解释和对话式 refinement。
...
讲 **AI Recommendation + LLM Hybrid System** 时，记住三个点。
