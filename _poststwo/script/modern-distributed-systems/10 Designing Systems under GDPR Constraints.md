...
Hello everyone.
Today I’d like to walk through **Designing Systems under GDPR Constraints**.
...
**(PPT 1: Title Slide — Designing Systems under GDPR Constraints)**
...
For **Designing Systems under GDPR Constraints**, I usually begin by asking three questions.
...
1. Core Framework
2. What Is GDPR?
3. Why GDPR Matters in System Design
4. GDPR Core Principles
...
For **Designing Systems under GDPR Constraints**, the important trade-offs are usually:
...
> Designing systems under GDPR constraints requires balancing traditional system design goals such as scalability, availability, and performance with privacy and regulatory requirements. Key requirements include identifying personal data, minimizing collection, managing consent, supporting user access requests, enabling data correction and deletion, enforcing retention policies, and controlling international data transfers. GDPR also introduces architectural requirements around encryption, auditing, data catalogs, and compliance workflows. Modern AI systems face additional challenges because personal data may appear in training datasets, vector
...
For **Designing Systems under GDPR Constraints**, remember three things.
...
大家好。
今天我们来讲 **Designing Systems under GDPR Constraints**。

这个 topic 的重点不是背一个固定答案，而是学会用 Staff 级思维解释一个系统设计问题。

一句话总结：

> Designing Systems under GDPR Constraints 的讲解重点是先讲清楚问题背景，再拆架构、流程、瓶颈、trade-off 和 Staff 级总结。
...
第一，Core Framework。
第二，What Is GDPR?。
第三，Why GDPR Matters in System Design。
第四，GDPR Core Principles。
第五，Personal Data Identification。
...
讲 **Designing Systems under GDPR Constraints** 时，记住三个点。
