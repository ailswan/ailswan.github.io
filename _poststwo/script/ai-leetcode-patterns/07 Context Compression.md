...
Hello everyone.
Today I’d like to walk through **Context Compression**.
...
**(PPT 1: Title Slide — Context Compression)**

---

## 1. Core Idea

The core idea of **Context Compression** is how the system fits useful information into a limited context window.

In a normal coding interview, we would focus on the algorithm.
For this topic, the algorithmic core is:

> sliding window, deduplication, greedy selection, knapsack-style packing, and summarization.
...
For **Context Compression**, I would say:
...
Then it applies the algorithmic core, which is sliding window, deduplication, greedy selection, knapsack-style packing, and summarization.
...
For **Context Compression**, the most important trade-offs are:

* compression ratio versus information loss
* recency versus importance
* extractive versus abstractive compression
...
For **Context Compression**, I would monitor:
...
> For **Context Compression**, I would first identify the LeetCode-style algorithm underneath the AI feature.
> The core is sliding window, deduplication, greedy selection, knapsack-style packing, and summarization.
...
> Context Compression 的核心是 how the system fits useful information into a limited context window。
...
> 对于 **Context Compression**，我会先找出 AI 功能背后的 LeetCode pattern。
> 它的核心是 sliding window, deduplication, greedy selection, knapsack-style packing, and summarization。
