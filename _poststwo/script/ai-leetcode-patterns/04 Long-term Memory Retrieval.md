...
Hello everyone.
Today I’d like to walk through **Long-term Memory Retrieval**.
...
**(PPT 1: Title Slide — Long-term Memory Retrieval)**

---

## 1. Core Idea

The core idea of **Long-term Memory Retrieval** is how an AI system stores useful memories and retrieves them in future tasks.

In a normal coding interview, we would focus on the algorithm.
For this topic, the algorithmic core is:

> semantic retrieval, time-indexed lookup, recency scoring, importance scoring, and Top-K ranking.
...
For **Long-term Memory Retrieval**, I would say:
...
Then it applies the algorithmic core, which is semantic retrieval, time-indexed lookup, recency scoring, importance scoring, and Top-K ranking.
...
For **Long-term Memory Retrieval**, the most important trade-offs are:

* personalization versus privacy
* recency versus importance
* saving more versus prompt pollution
* semantic recall versus precision
...
For **Long-term Memory Retrieval**, I would monitor:
...
> For **Long-term Memory Retrieval**, I would first identify the LeetCode-style algorithm underneath the AI feature.
> The core is semantic retrieval, time-indexed lookup, recency scoring, importance scoring, and Top-K ranking.
...
大家好。
今天我们讲 **Long-term Memory Retrieval**。
...
> Long-term Memory Retrieval 的核心是 how an AI system stores useful memories and retrieves them in future tasks。
...
> 对于 **Long-term Memory Retrieval**，我会先找出 AI 功能背后的 LeetCode pattern。
> 它的核心是 semantic retrieval, time-indexed lookup, recency scoring, importance scoring, and Top-K ranking。
