...
Hello everyone.
Today I’d like to walk through **Real-time vs Batch Systems**.
...
**(PPT 1: Title Slide — Real-time vs Batch Systems)**
...
For **Real-time vs Batch Systems**, I usually begin by asking three questions.
...
For **Real-time vs Batch Systems**, the important trade-offs are usually:

* choose stream or batch by SLA
* use micro-batching when appropriate
* handle ordering and late data
...
For **Real-time vs Batch Systems**, remember three things.
...
大家好。
今天我们来讲 **Real-time vs Batch Systems**。
...
讲 **Real-time vs Batch Systems** 时，记住三个点。
