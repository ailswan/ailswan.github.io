...
Hello everyone.
Today I’d like to walk through **Strong vs Eventual Consistency**.
...
**(PPT 1: Title Slide — Strong vs Eventual Consistency)**
...
For **Strong vs Eventual Consistency**, I usually begin by asking three questions.
...
For **Strong vs Eventual Consistency**, the important trade-offs are usually:

* map consistency to business invariants
* choose read-after-write where needed
...
For **Strong vs Eventual Consistency**, remember three things.
...
大家好。
今天我们来讲 **Strong vs Eventual Consistency**。
...
讲 **Strong vs Eventual Consistency** 时，记住三个点。
