...
## How to Handle Unknown Requirements in Interviews
...
Hello everyone.
Today I’d like to walk through **How to Handle Unknown Requirements in Interviews**.
...
**(PPT 1: Title Slide — How to Handle Unknown Requirements in Interviews)**
...
For **How to Handle Unknown Requirements in Interviews**, I usually begin by asking three questions.
...
For **How to Handle Unknown Requirements in Interviews**, the important trade-offs are usually:

* prioritize likely requirements
* design for flexibility where cheap
...
> I would approach **How to Handle Unknown Requirements in Interviews** with a clear interview structure: clarify, scope, estimate, design, deep dive, trade off, and summarize. The goal is to demonstrate senior engineering judgment under ambiguity. A strong answer should be easy to follow, grounded in requirements, explicit about trade-offs, and realistic about failure handling, observability, and operational cost.
...
For **How to Handle Unknown Requirements in Interviews**, remember three things.
...
大家好。
今天我们来讲 **How to Handle Unknown Requirements in Interviews**。

这个 topic 的重点不是背一个固定答案，而是学会用 Staff 级思维解释一个系统设计问题。

一句话总结：

> 遇到未知需求不要卡住。要问 targeted questions，明确 assumptions，先做 baseline，再说明如果 requirement 变化如何调整。
...
讲 **How to Handle Unknown Requirements in Interviews** 时，记住三个点。
