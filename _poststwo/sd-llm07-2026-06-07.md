---
title: 07 Hallucination Control System
level: interview
layout: post
categories:
...
feature_image: "https://picsum.photos/2560/600?image=996"
---
...
> For Hallucination Control System, I would start from the traditional system design baseline, then explain what changes when the core capability is powered by an LLM.
...
> For Hallucination Control System, I would design a layered architecture.
...
> For Hallucination Control System, I would not replace traditional system design with an LLM call.
...
> For Hallucination Control System, I would upgrade a traditional system design answer by adding an LLM orchestration layer.
...
> 对于 Hallucination Control System，我会先从传统系统设计开始，而不是直接说调用 LLM。
...
在 **Hallucination Control System** 中具体要讲：
...
> 讲 Hallucination Control System 时，我会明确区分传统系统部分和 LLM 特有部分。
...
> Hallucination Control System 的 Staff 级答案，是从传统 SD 过渡到 LLM 系统设计。
> 传统 SD 提供稳定的分布式系统基础。
