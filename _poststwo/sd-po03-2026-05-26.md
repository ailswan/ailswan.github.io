---
title: "03 Cold Start Problem in Large Systems"
level: interview
layout: post
categories:
...
feature_image: "https://picsum.photos/2560/600?image=603"
---
...
1. identify what is cold: process, container, model, cache, connection, JIT, or metadata
2. distinguish startup latency from steady-state latency
3. warm critical resources before traffic
4. control rollout and autoscaling ramp-up
5. use readiness checks instead of only liveness checks
6. preload caches and connection pools carefully
7. protect databases during mass warm-up
8. measure cold-start frequency and impact
...
> I would approach **Cold Start Problem in Large Systems** by measuring first, decomposing the critical path, and identifying the real bottleneck.
