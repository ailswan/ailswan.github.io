---
title: "06 Database Connection Pool Optimization"
level: interview
layout: post
categories:
...
feature_image: "https://picsum.photos/2560/600?image=606"
---
...
* set max pool size based on DB capacity
* use acquisition timeout to fail fast
* release connections in finally/defer blocks
* keep transactions short
* separate OLTP and analytics workloads
* use read replicas for read-heavy traffic
* detect leaked connections
* scale app instances without multiplying DB connections beyond capacity
...
* letting every app instance open too many connections
* holding connections during remote calls
* not setting acquisition timeouts
* mixing long analytics queries with user traffic
...
> I would approach **Database Connection Pool Optimization** by measuring first, decomposing the critical path, and identifying the real bottleneck.
